...
t = time.time()
s = DirectedPointSource(Point(0, 0, 0), n_rays=int(5e7),
                        direction=Point(0, 0, 1), psi=np.pi/2)
...
d = Detector(Point(0, 0, 5),
             x_edge=Point(2, 0, 5), y_edge=Point(0, 2, 5),
             xnpix=100, ynpix=100)
...
m.plot_results('lens_array_point_source.pdf', src=src)
